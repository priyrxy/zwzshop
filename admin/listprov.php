...
$sql="select id,username,email from shop_prov order by id asc limit {$offset},{$pageSize}";
$rows=fetchAll($sql);
if(!$rows){
	alertMes("sorry,没有供货商,请添加!","addprov.php");
	exit;
}
?>
<!doctype html>
