        ...
        <div class="menu">
            <div class="cont">
                ...
                <ul class="mList">
                    ...
                    <li>
                        <h3><span onclick="show('menu3','change3')" id="change3">+</span>商品图片管理</h3>
                    ...
                    <li>
                        <h3><span onclick="show('menu6','change6')" id="change6">+</span>商家管理</h3>
                        <dl id="menu6" style="display:none;">
                        	<dd><a href="addshopper.php" target="mainFrame">添加商家</a></dd>
                            <dd><a href="listshopper.php" target="mainFrame">商家列表</a></dd>
                        </dl>
                    </li>
                    <li>
                        <h3><span onclick="show('menu7','change7')" id="change7">+</span>供货商管理</h3>
                        <dl id="menu7" style="display:none;">
                        	<dd><a href="addprov.php" target="mainFrame">添加供货商</a></dd>
                            <dd><a href="listprov.php" target="mainFrame">供货商列表</a></dd>
                        </dl>
                    </li>
