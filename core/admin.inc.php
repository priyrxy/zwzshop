...
function addshopper(){
    ...
    $arr['password']=md5($_POST['password']);
    //print_r($arr);
    $mes=insert("shop_er", $arr);
    
    if($mes){
        $mes="添加成功！<br/><a href='addshopper.php'>继续添加</a>
            |<a href='listshopper.php'>查看商家列表</a>";
    }else{
        $mes="添加失败！<br/><a href='addshopper.php'>重新添加</a>";
    }
    return $mes;
}
function addprov(){
    ...
    $arr['password']=md5($_POST['password']);
    //print_r($arr);
    $mes=insert("shop_prov", $arr);
    
    if($mes){
        $mes="添加成功！<br/><a href='addprov.php'>继续添加</a>
            |<a href='listprov.php'>查看供货商列表</a>";
    }else{
        $mes="添加失败！<br/><a href='addprov.php'>重新添加</a>";
    }
    return $mes;
}
